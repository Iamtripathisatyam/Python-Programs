import re
strr = """ Email:enquiry@alliance.edu.in   Helpline: +91 80 3093 8100 / 8200 / 4619 9100
...
Edinburgh Napier University
UK
satyampsit26390@gmail.com,satyammahoba210427@gmail.com,tripathistayam5721@gmail.com
...
email = re.findall(r"[0-9a-zA-Z._+]+@[0-9a-zA-Z._+%]+[.][a-zA-Z.0-9]+", strr)
f=open("codewith.txt","w")
a=1
for i in email:
    f.write(f"Email {a} : {i}")
    f.write('\n')
